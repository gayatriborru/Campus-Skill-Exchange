    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      >
        ...
        <div className="flex items-center gap-1 p-1 bg-slate-100 rounded-xl self-start sm:self-auto">
          <motion.button
            ...
            className={`btn-press px-3.5 py-2 rounded-lg text-xs font-bold transition-all ${
          ...
          <motion.button
            ...
            className={`btn-press px-3.5 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ${
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <motion.div
          ...
          className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs flex items-center gap-4 card-hover-lift"
        >
        ...
        {activeTab === 'overview' && (
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-xs space-y-4 card-hover-lift">
                <div>
                      ...
                      <tr key={st._id} className="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td className="px-6 py-3.5 text-right">
                          <motion.button
                            ...
                            className={`btn-press inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-bold transition-colors cursor-pointer ${
                              st.isBlocked
                    ...
                    {r.status === 'pending' && (
                      <div className="flex items-center justify-end gap-2 pt-2">
                        <motion.button
                          ...
                          className="btn-press px-3 py-1.5 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100 text-xs font-semibold cursor-pointer"
                        >
                          Dismiss Flag
                        </motion.button>
                        <motion.button
                          ...
                          className="btn-press px-3.5 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-xs cursor-pointer"
                        >
                          Resolve & Close
                        </motion.button>
                      </div>
