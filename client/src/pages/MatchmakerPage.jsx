...
const MatchmakerPage = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      {/* Header Banner */}
      <div className="bg-gradient-to-r from-brand-900 via-indigo-900 to-slate-900 rounded-3xl p-8 sm:p-10 text-white relative overflow-hidden shadow-xl">
              ...
              >
                  ...
                  <div className="flex items-start justify-between gap-4 mb-4">
                    <div className="flex items-start gap-3">
                      <img
                        ...
                        className="w-13 h-13 rounded-full object-cover border-2 border-brand-200 flex-shrink-0"
                      />
                      <div>
                        <div className="flex items-center gap-2">
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center gap-2">
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-700 text-white text-xs font-bold shadow-xs transition-colors flex items-center justify-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-2.5 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 text-xs font-semibold transition-colors"
                  >
                    View
                  </button>
                </div>
